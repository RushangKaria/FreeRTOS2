...
extern void vUART_ISR_Wrapper( void );	//to make the long jump
...
#if 0
	else if((*(REG32(MPU_INTC + INTCPS_SIR_IRQ)))==74)	//no need for this since ISR for UART only needs to be enabled when printk's are called
	{
