...
static int prvGetNextExpiringTimer( portBASE_TYPE *pxListWasEmpty );
...
int x=prvGetNextExpiringTimer( &xListWasEmpty );	//get the next expiring timer id
...
return 	prvGetNextExpireTime( &xListWasEmpty );
}
/*-----------------------------------------------------------*/
...
xTIMER *timer;
	...
	*pxListWasEmpty = listLIST_IS_EMPTY( pxCurrentTimerList );
	...
	{
		timer = ( xTIMER * ) listGET_OWNER_OF_HEAD_ENTRY( pxCurrentTimerList );

	return timer->pvTimerID;
	}
	else
	{
