...
#define xTaskCreate( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask ) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( 0 ), ( pxCreatedTask ), ( NULL ), ( NULL ) )

#if (configREAL_TIME_TASK == 1 )
#define xTaskCreateRT( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, deadline , pxCreatedTask ) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( deadline ), ( pxCreatedTask ), ( NULL ), ( NULL ) )
#else
#define xTaskCreateRT( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, deadline , pxCreatedTask ) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( 0 ), ( pxCreatedTask ), ( NULL ), ( NULL ) )
#endif
 ...
 */
signed portBASE_TYPE xTaskGenericCreate( pdTASK_CODE pxTaskCode, const signed char * const pcName, unsigned short usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, unsigned int deadline, xTaskHandle *pxCreatedTask, portSTACK_TYPE *puxStackBuffer, const xMemoryRegion * const xRegions ) PRIVILEGED_FUNCTION;
